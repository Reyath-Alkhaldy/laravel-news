            ...
            <ul class="nav navbar-nav pull-left hidden-md-down">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" href="#" role="button"
                        ...
                        <img src="{{ asset('assets/img/avatars/6.jpg') }}" class="img-avatar"
            ...
            <div class="tab-pane active" id="timeline" role="tabpanel">
                ...
                <div class="callout callout-warning m-a-0 p-y-1">
                    <div class="avatar pull-xs-right">
                        <img src="{{ asset('assets/img/avatars/7.jpg') }}" class="img-avatar"
                            alt="admin@bootstrapmaster.com">
                    </div>
                    <div>Meeting with
                        <strong>Lucas</strong>
                ...
                <div class="callout callout-info m-a-0 p-y-1">
                    <div class="avatar pull-xs-right">
                        <img src="{{ asset('assets/img/avatars/4.jpg') }}" class="img-avatar"
                            alt="admin@bootstrapmaster.com">
                    </div>
                    <div>Skype with
                        <strong>Megan</strong>
                ...
                <div class="callout callout-danger m-a-0 p-y-1">
                    ...
                    <div class="avatars-stack m-t-h">
                        <div class="avatar avatar-xs">
                            <img src="{{ asset('assets/img/avatars/2.jpg') }}" class="img-avatar"
                                alt="admin@bootstrapmaster.com">
                        </div>
                        <div class="avatar avatar-xs">
                            <img src="{{ asset('assets/img/avatars/3.jpg') }}" class="img-avatar"
                                alt="admin@bootstrapmaster.com">
                        </div>
                        <div class="avatar avatar-xs">
                            <img src="{{ asset('assets/img/avatars/4.jpg') }}" class="img-avatar"
                        ...
                        <div class="avatar avatar-xs">
                            <img src="{{ asset('assets/img/avatars/5.jpg') }}" class="img-avatar"
                                alt="admin@bootstrapmaster.com">
                        </div>
                        <div class="avatar avatar-xs">
                            <img src="{{ asset('assets/img/avatars/6.jpg') }}" class="img-avatar"
                ...
                <div class="callout callout-primary m-a-0 p-y-1">
                    ...
                    <div class="avatars-stack m-t-h">
                        ...
                        <div class="avatar avatar-xs">
                            <img src="{{ asset('assets/img/avatars/8.jpg') }}" class="img-avatar"
                                alt="admin@bootstrapmaster.com">
                        </div>
                    </div>
                </div>
